    ...
    <body>
        ...
        <section class="encabezado_section">
            <div class="ctnEncabezado">
                <h1 class="textoTitulos">Bebidas</h1>
            </div>
            <div class="ctnButton">
                ...
                <div class="cards__recetas textoChico row">
                    <?php
                        ...
                        $sql = mysqli_query($conexion,
                            "SELECT * FROM recetas WHERE ingredientes__receta LIKE '%bebidas%'
                            OR ingredientes__receta LIKE '%bebida%'"
                        );
