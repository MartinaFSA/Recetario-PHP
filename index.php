    ...
    <main>
        ...
        <section id="ctn_searchSecc">
            <div class="flexAndCenter">
                <form id="searchSecc__form" class="col-auto">
                    <input type="search" name="buscadorSearchSecc" id="searchSecc__form--input" placeholder="Buscar">
                    <button id="searchSecc__form--button" type="submit">Buscar</button>    
                </form>
