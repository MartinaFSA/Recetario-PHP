    ...
    <body>
        ...
        <main>
            <section class="formCtn">
                <div id="form__ctnH1">
                    <h1 class="formH1 textoTitulos">Registrate</h1>
                </div>
                ...
                <div class="cajaConForm">
                    <form action="componentes/register.php" method="POST"> <!--CAMBIAR EL METHOD A POST y que no redireccione a otra pestaña-->
                        ...
                        <br>
                        <input type="text" name="mailRegister" id="register--formMail" class="form--input textoChico" placeholder="laura@ejemplo.com" require autofocus>
                        <br>

                        <label for="register--formContraseña">Contraseña</label>
                        <br>
                        <input type="password" name="contraseñaRegister" id="register--formContraseña" class="form--input textoChico" require>
                        <br>
                        
                        <input type="submit" class="form--button textoChico" value="Registrarme">
                    </form>
                </div>
