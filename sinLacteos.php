...
<html lang="es">
    ...
    <body>
        ...
        <section>
            ...
            <p class="texto_indicaciones">TIP: Si te gusta alguna receta que contenga lácteos, probá reemplazarlos con margarina, levadura de cerveza sabor a queso, leche o crema vegetal, etc.</p>
        </section>
