...
<html lang="es">
    <head>
        ...
        <title>Recetario - Recetas veganas</title>
    ...
    <body>
        ...
        <section class="encabezado_section">
            <div class="ctnEncabezado">
                <h1 class="textoTitulos">Recetas veganas</h1>
            </div>
            <div class="ctnButton">
        ...
        <section>
            <p class="texto_indicaciones">Las siguientes recetas no contienen derivados de animales.</p>
            <p class="texto_indicaciones">TIP: Si te gusta alguna receta que contenga ingredientes de origen animal, probá reemplazarlos con <a href="tips/recetas_veganas.php">estos ingredientes</a>.</p>
        </section>
                ...
                <div class="cards__recetas textoChico row">
                    <?php
                        ...
                        $sql = mysqli_query($conexion,
                            "SELECT * FROM recetas WHERE ingredientes__receta LIKE '%vegana%'"
                        );
